...
jags0 <- jags.model("mod5.txt", n.chains = 3, data = list("obs" = obs, "N_cas" = length(obs)))
...
jags2 <- jags.model("mod6.txt", n.chains = 3, data = list("obs" = obs, "N_cas" = length(obs)))

ech_post3 <- coda.samples(jags2, variable.names = c("theta", "eff"), n.iter = 3000)
